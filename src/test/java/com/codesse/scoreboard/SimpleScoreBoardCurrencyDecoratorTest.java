...
public class SimpleScoreBoardCurrencyDecoratorTest extends TestCase {
    ...
    public static final String FOUR_LETTER_WORD = "abba";
        private ScoreBoard scoreBoard = new SimpleScoreBoardCurrencyDecorator(new SimpleFixedScoreBoard());
